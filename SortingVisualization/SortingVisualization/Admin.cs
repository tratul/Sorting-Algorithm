...
namespace SortingVisualization
{
    public partial class Admin : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'sorting_algoDataSet3.register' table. You can move, or remove it, as needed.
            this.registerTableAdapter.Fill(this.sorting_algoDataSet3.register);
